...
insert into convenio(codigo, descricao, tipo) 
values (1, 'Unimed Criciúma', 'Oq é tipo');
insert into convenio(codigo, descricao, tipo) 
values (2, 'São José Criciúma', 'sla');
insert into convenio(codigo, descricao, tipo) 
values (3, 'Hospital inclusivo para pessoas com problemas de saúde', 'aaaa');

insert into medico(crm, endereco, telefone, cidade, estado, especialidade) 
values (12345, 'Rua Carlos', 12345678, 'São Paulo', 'SP', 'Cardiologista');
insert into medico(crm, endereco, telefone, cidade, estado, especialidade) 
values (54321, 'Avenida Carlos', 87654321, 'Rio de Janeiro', 'RJ', 'Dermatologista');
insert into medico(crm, endereco, telefone, cidade, estado, especialidade) 
values (11223, 'Rua Alberto', 76543210, 'Belo Horizonte', 'MG', 'Ortopedista');

insert into consulta(codigo, dataConsulta,hora, tipo, codigoPaciente, codigoConvenio, codigoMedico) 
values (1, '2024/08/15', '09:00', 'Rotina', 1, 1, 12345);
insert into consulta(codigo, dataConsulta,hora, tipo, codigoPaciente, codigoConvenio, codigoMedico) 
values (2, '2024/08/24', '10:00', 'Emergência', 2, 2, 54321);
insert into consulta(codigo, dataConsulta,hora, tipo, codigoPaciente, codigoConvenio, codigoMedico) 
values (3, '2024/09/02', '14:00', 'Rotina', 3, 3, 11223);

insert into exame(codigo, descricao, tipo, dataExame, resultado, codigoConsulta) 
values (1, 'Exame de Sangue', 'Coleta de sangue', '2024/08/15', 'Normal', 1);
insert into exame(codigo, descricao, tipo, dataExame, resultado, codigoConsulta) 
values (2, 'Radiografia de Tórax', 'Laboratório', '2024/08/24', 'Melhor', 2);
insert into exame(codigo, descricao, tipo, dataExame, resultado, codigoConsulta) 
values (3, 'Ultrassonografia Abdominal', 'Endoscopia', '2024/09/02', 'Anormal', 3);

update convenio set descricao = "Plano Unimed"
where codigo = 1;

delete from convenio where codigo = 3;